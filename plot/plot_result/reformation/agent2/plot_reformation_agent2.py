...
def plot_heading_results():
    ...
    # 设置图表标题和标签
    ax.set_title("reformation Policy Training Performance(agent2)", fontsize=14)
    ...
    # 调整布局并保存
    plt.tight_layout()
    plt.savefig("/home/dqy/NeuralPlanex/AeroPlanex_v/AeroPlanax/plot/plot_result/reformation/agent2/reformation_policy_return_by_seed(agent2).png", bbox_inches="tight")
    plt.savefig("/home/dqy/NeuralPlanex/AeroPlanex_v/AeroPlanax/plot/plot_result/reformation/agent2/reformation_policy_return_by_seed(agent2).pdf", bbox_inches="tight")
    print("\n图表已保存为 reformation_policy_return_by_seed(agent2).png 和 reformation_policy_return_by_seed(agent2).pdf")
    plt.show()
