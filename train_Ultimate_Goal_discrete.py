...
from envs.aeroplanax_ultimate_goal import AeroPlanax_turning_maneuverability_Env, turning_maneuverability_TaskParams
...
config = {
    "GROUP": "ultimate_goal(max_15.0)_seed_42",
    "SEED": 42,
    "LR": 3e-4,
    "NUM_ENVS": 300,
    "NUM_ACTORS": 1,
