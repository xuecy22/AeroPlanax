...
def test(config, rng):
    ...
    def _env_step(test_state):
        ...
        # action = jnp.array([[[0.5, 0, 0, 0]]])
        # jax.debug.print(f'action{action.shape}')
    ...
    for _ in range(1000):
        ...
        print(f'Time: {env_state.time}, Done: {test_state[2]}, Reward: {traj_batch.reward}, rpy: {env_state.plane_state.roll, env_state.plane_state.pitch, env_state.plane_state.yaw}'),
...
config = {
    ...
    "ACTIVATION": "relu",
    "ANNEAL_LR": False,
    "LOADDIR": "/home/dqy/NeuralPlanex/AeroPlanex_v/AeroPlanax/results/2025-03-25-11-22/checkpoints/checkpoint_epoch_333" 
}
