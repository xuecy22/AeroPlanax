...
class ActorCriticRNN_Test(nn.Module):
    action_dim: Sequence[int]
    config: Dict
...
def init_network(obs_size : int, global_obs_size : int, config : Dict[str, Any], discrete_action_dims : List[int] = PPO_DISCRETE_HIERARCHY_DEFAULT_DIMS) -> Tuple[Tuple[nn.Module, nn.Module], Tuple[TrainState, TrainState], int]:
